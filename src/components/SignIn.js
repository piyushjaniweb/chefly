...
import cheflylandingpage from "../assets/cheflylandingpage.png";
const SignIn = () => {
  return (
    <div className="flex flex-col items-center justify-start min-h-screen mt-40 ">
      <img
        src={cheflylandingpage}
        alt=""
      ...
      <div className="flex items-center justify-center p-4">
        <a
          href="/"
          className="px-5 py-3 bg-[#348fde] text-white font-medium mb-4 shadow-sm hover:shadow-md"
        >
          Go Back to Homepage
        </a>
      </div>
