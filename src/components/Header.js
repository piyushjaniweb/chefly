      ...
      >
        <div className="max-w-[25%] flex items-center gap-2">
          ...
          >
            ...
            >
              <span className="text-md mr-1 leading tracking-tight font-bold border-b border-black hover:text-[#348fde]">
                Other
              </span>
              {area + ", " + city + ", " + state}
            </h2>
        ...
        <>
          <ul className="list-none flex justify-center items-center text-xl text-[#3d4152]">
            <li
              className="transition duration-250 ease-in-out m-3 flex items-center justify-center text-[#303031] hover:text-[#348fde]"
              onMouseOver={(e) => {
            ...
            >
              <NavLink
                ...
                className={`${
                  isActive("/search") ? "text-[#348fde]" : "text-inherit"
                }`}
                to="/search"
              >
                <span className="flex items-center justify-center truncate">
                  <svg
                    ...
                    className={`w-[17px] h-[17px] ${
                      isActive("/search") ? "fill-[#348fde]" : "fill-[#686b78]"
                    }`}
                  >
            ...
            <li
              className="transition duration-250 ease-in-out m-3 pl-8 flex items-center justify-center text-[#303031] hover:text-[#348fde]"
              onMouseOver={(e) => {
                e.currentTarget.querySelector("svg").style.fill = "#348fde";
              }}
              onMouseOut={(e) => {
                e.currentTarget.querySelector("svg").style.fill = "";
              }}
            >
              <NavLink
                ...
                className={`${
                  isActive("/help") ? "text-[#348fde]" : "text-inherit"
                }`}
                to="/help"
              >
                <span className="flex items-center justify-center truncate">
                  <svg
                    ...
                    className={`w-[18px] h-[19px] ${
                      isActive("/help") ? "fill-[#348fde]" : "fill-[#686b78]"
                    }`}
                  >
            ...
            >
              <NavLink
                ...
                className={`${
                  isActive("/profile") ? "text-[#348fde]" : "text-inherit"
                }`}
                to="/profile"
              >
                <span className="flex items-center justify-center truncate">
                  <svg
                    viewBox="6 0 12 24"
                    className={`w-[18px] h-[19px] ${
                      isActive("/profile") ? "fill-[#348fde]" : "fill-[#686b78]"
                    }`}
                  >
            ...
            >
              <NavLink
                ...
                className={`${
                  isActive("/cart") ? "text-[#348fde]" : "text-inherit"
                }`}
                to="/cart"
              >
                <span className="flex items-center justify-center truncate">
