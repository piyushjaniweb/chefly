...
const Footer = ({ footerCities }) => {
  ...
  return (
    <>
      <div className="flex bg-[#110705] text-[#ffffff99] flex-col items-center justify-center p-10">
        <div className="grid grid-cols-4 gap-x-[5%] w-[85%] mx-auto">
          <div>
            ...
            {/* <h1 className="truncate">© 2024  Piyush Jani</h1> */}
          </div>
      ...
      <div className="flex flex-col w-full items-center justify-center bg-[#110705] text-white ">
        <p className="py-2">
          Made with 💓 by Piyush, Let's connect beyond the Plate
        </p>
  ...
  <a
    href="https://www.instagram.com/piyush__jani2233"
    target="_blank"
    rel="noopener noreferrer"
  >
    <FontAwesomeIcon className="text-3xl hover:text-[#d33592]" icon={faInstagram} />
  </a>
</div>
